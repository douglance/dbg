...
import { registerFlowsCommands } from "./commands/flows.js";
...
import { registerTapCommands } from "./commands/taps.js";
...
registerPlayCommand(cli);
registerTapCommands(cli);
registerFlowsCommands(cli);
